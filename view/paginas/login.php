...
<body>
    <?php if ($conexionpruebalogin != null) {?>
                    ...
                    <div class="col-auto px-5 mb-5 text-center">
                        <div class="card login-card">
                            <div class="card-body">
                                ...
                                <?php }elseif ($intentos == 4) {?>
                                    <div class="login-card-header">
                                        <h3 class="text-danger">Se excedió el limite de intentos posibles.</h3>
                                        <?php //echo "<h5 class='text-danger'>Podrá intentar después de $cache_expire minutos.</h5>";?>
                                    </div>
                                <?php }?>
                            </div>
                        </div>
    ...
    <?php } elseif ($conexionpruebalogin == null) {
        echo "sakjbhdjsagvd";
    }?>
