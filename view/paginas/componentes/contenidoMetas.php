...
$sql1 = "select * from whatsapp where producto='movil' and tipo='Portabilidad' and(planR='S/ 29.90 MAX' or planR='S/ 39.90' or planR='S/ 49.90' or planR='S/ 55.90') and estado='1'";
...
$sql2 = "select * from whatsapp where producto='movil' and tipo='Portabilidad' and(planR!='S/ 29.90 MAX' and planR!='S/ 39.90' and planR!='S/ 49.90' and planR!='S/ 55.90' and planR!='---') and estado='1'";
...
$sql3 = "select * from whatsapp where producto='movil' and tipo='Linea Nueva' and modalidad='Postpago' and estado='1'";
...
$sql3 = "select * from whatsapp where producto='movil' and tipo='Linea Nueva' and modalidad='prepago' and estado='1'";
$resultado3 = sqlsrv_query($consulta,$sql3, array(), array("Scrollable"=>"buffered"));
$ventasAltPre = sqlsrv_num_rows($resultado3);
// progreso portabilidad prepago
$sql3 = "select * from whatsapp where producto='movil' and tipo='Portabilidad' and modalidad='Prepago' and estado='1'";
$resultado3 = sqlsrv_query($consulta,$sql3, array(), array("Scrollable"=>"buffered"));
$ventasPortPre = sqlsrv_num_rows($resultado3);
// progreso renovaciones
$sql3 = "select * from whatsapp where producto='movil' and tipo='Renovacion' and estado='1'";
$resultado3 = sqlsrv_query($consulta,$sql3, array(), array("Scrollable"=>"buffered"));
$ventasReno = sqlsrv_num_rows($resultado3);
// progreso fija ftth
$sql3 = "select * from whatsapp where producto='Fija' and (modoFija='HFC' or modoFija='FTTH') and estado='1'";
$resultado3 = sqlsrv_query($consulta,$sql3, array(), array("Scrollable"=>"buffered"));
$ventasFijaFtth = sqlsrv_num_rows($resultado3);
// progreso fija ifi
$sql3 = "select * from whatsapp where producto='Fija' and modoFija='IFI' and estado='1'";
$resultado3 = sqlsrv_query($consulta,$sql3, array(), array("Scrollable"=>"buffered"));
